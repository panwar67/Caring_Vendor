...
import com.lions.caring_vendor.options.Accepted_Booking;
 ...
 */
public class Accepted_Adapter extends BaseAdapter{
    ...
    public Accepted_Adapter(Context cont, ArrayList<Pending_Booking_Bean> data, String lati, String longi)
    {
        context = cont;
        result = data;
        latitude = lati;
